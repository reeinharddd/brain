...
1. **Stack Detection**: Identify language, framework, and tooling from the repository files and existing configuration.
...
4. **Configuration Generation**:
   ...
   - Load only the matching stack contexts for the detected project.
